...
assert.ok(indexHtml.includes('LC_MEDIAINFO_WASM_MODE_V5'), 'index.html must include WASM mode signature');
...
assert.ok(indexHtml.includes('vendor/mediainfo-fichegen/MediaInfoWasm.js'), 'index.html should prioritize fichegen vendor script');
